...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/clize-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9132&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/clize-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `clize` can be installed with:

```
conda install clize
```

It is possible to list all of the versions of `clize` available on your platform with:
